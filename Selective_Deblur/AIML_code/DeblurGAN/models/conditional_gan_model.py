...
class ConditionalGAN(BaseModel):
	...
	def backward_G(self):
		...
		# print ("[conditional_gan_model]:",self.real_A)


		### add yolo loss ####
		self.yolo_loss_scale=1000  ### scale for Yolo Tong Lin, 100 is comparable to initial G loss  
		self.G_loss_scale=0.1 ### scale for G_loss Tong Lin
